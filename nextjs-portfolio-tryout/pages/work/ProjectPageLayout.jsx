...
export default function ProjectPageLayout({ date, body, title, subtitle }) {
            ...
            <Grid container spacing={5}>
              <Grid item xs={12} md={8}>
                <Stack spacing={2}>
                  ...
                  <PageTitle className="markdown-title">{title}</PageTitle>
                  <PageSubtitle className="markdown-subtitle">{subtitle}</PageSubtitle>
                  <ReactMarkdown
