...
function CareerEntry({ job_title, company, company_about, company_logo, year }) {
  return (
    <>
            ...
            <Stack direction="column" spacing={2}>
              ...
              <Stack direction="column">
                <Typography variant="caption" sx={{ color: '#fff', opacity: 0.7 }}>
                  {company}&nbsp;
                  <Link href={company_about} sx={{ color: '#fff', opacity: 0.7 }}>
                    ( About chinamobile )
                  </Link>
                </Typography>
    ...
    <>
      ...
      <Container maxWidth="lg">
        <Grid container flexDirection="column" rowGap={10}>
          ...
          <Grid item xs={12} container spacing={8} justifyContent="center" alignItems="flex-start">
      ...
      >
        <Container maxWidth="xl">
          <Stack justifyContent="center" spacing={5}>
            <Typography variant="h3" sx={{ color: theme.palette.deep_background.contrastText }}>
              Louis Law
            </Typography>
            <Stack direction="column" spacing={2}>
