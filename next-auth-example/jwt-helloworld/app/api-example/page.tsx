  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col bg-gray-100 rounded-md">
        <div className="p-4 font-bold bg-gray-200 rounded-t-md">Data from API Route</div>
        <pre className="py-6 px-4 whitespace-pre-wrap break-all">{JSON.stringify(data, null, 2)}</pre>
      </div>
    </div>
  );
}
